...
export default async function BillingPage({
  ...
  const featureLabels: Record<FeatureKey, string> = {
    // Base features
    dashboard_home: t("featureLabel_dashboard_home"),
    account_settings: t("featureLabel_account_settings"),
    plan_comparison_view: t("featureLabel_plan_comparison_view"),
    billing_manage: t("featureLabel_billing_manage"),
    tokens_view: t("featureLabel_tokens_view"),
    // 8 Products
    core_os: t("featureLabel_core_os"),
    meta_hub: t("featureLabel_meta_hub"),
    studio: t("featureLabel_studio"),
    helper: t("featureLabel_helper"),
    links: t("featureLabel_links"),
    office: t("featureLabel_office"),
    marketplace: t("featureLabel_marketplace"),
    apps: t("featureLabel_apps"),
    // Legacy/capabilities
    graph: t("featureLabel_graph"),
    tracks: t("featureLabel_tracks"),
    inbox: t("featureLabel_inbox"),
    automation: t("featureLabel_automation"),
    studio_graph: t("featureLabel_studio_graph"),
    mass_blast: t("featureLabel_mass_blast"),
    wa_blast: t("featureLabel_wa_blast"),
    analytics: t("featureLabel_analytics"),
    member_invites: t("featureLabel_member_invites"),
    roles_permissions: t("featureLabel_roles_permissions"),
    audit_log: t("featureLabel_audit_log"),
    meta_connect: t("featureLabel_meta_connect"),
    meta_send: t("featureLabel_meta_send"),
    meta_templates: t("featureLabel_meta_templates"),
    meta_webhooks: t("featureLabel_meta_webhooks"),
  };
