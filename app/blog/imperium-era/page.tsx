  ...
  return (
    <div className="min-h-screen bg-[#050a18]">
        ...
        <div className="mx-auto max-w-4xl space-y-16">
          ...
          >
            ...
            <div className="relative space-y-6">
              ...
              <p className="text-[#f5f5dc]/80 leading-relaxed">
                This verification — visible directly in Meta&apos;s Business Manager and the official Tech Provider Directory — 
          ...
          >
            ...
            <p className="text-[#f5f5dc]/80 leading-relaxed">
              Every element — from the constellation-patterned backgrounds to the glassmorphic cards — 
          ...
          >
            ...
            <p className="text-[#f5f5dc]/80 leading-relaxed">
              Gigaviz is not a single product — it&apos;s an interconnected ecosystem of 10 specialized modules, 
      ...
      {/* ─────────────────────────────────────────────────────────────────────
          FOOTER
         ───────────────────────────────────────────────────────────────────── */}
      <footer className="border-t border-[#d4af37]/10 bg-[#050a18]">
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col items-center justify-between gap-4 text-sm text-[#f5f5dc]/40 md:flex-row">
            <p>© {new Date().getFullYear()} Gigaviz — Glorious Victorious.</p>
            <div className="flex gap-6">
              <Link href="/policies/privacy-policy" className="transition-colors hover:text-[#d4af37]">
                Privacy Policy
              </Link>
              <Link href="/policies/terms-of-service" className="transition-colors hover:text-[#d4af37]">
                Terms of Service
              </Link>
