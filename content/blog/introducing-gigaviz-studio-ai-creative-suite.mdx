...
Each module has its own entitlement key: `office`, `graph`, `tracks`. Access is checked both at the page level (Server Component) and the API level (middleware). If your plan doesn't include Graph, you see a clear upgrade prompt — not a broken page.
